...
import { getEntitiesByUris, type GetEntitiesByUrisArgs } from './get_entities_by_uris.js'
...
export async function getEntitiesList (uris: EntityUri[], params: Omit<GetEntitiesByUrisArgs, 'uris'> = {}) {
  if (uris == null) return []
  uris = compact(uris)
