...
describe('entities:resolve:non-strict mode', function() {
  it('should ignore and report sanitization errors', function(done){
    const entry = { edition: {} };
  ...
  return it('should ignore and report create errors', function(done){
    const entry = {
      edition: {
        isbn: generateIsbn13(),
