...
describe('entities:resolver:update-resolved', function() {
  it('should not update entity claim values if property exists', function(done){
  ...
  it('should update entities claims values if property does not exist', function(done){
  ...
  it('should update authors claims', function(done){
    const goodReadsId = someGoodReadsId();
  ...
  it('should update edition claims', function(done){
  ...
  return it('should add a batch timestamp to patches', function(done){
    ...
    .spread(function(workAPatches, workBPatches){
