...
describe('entities:editions:create', function() {
  it('should not be able to create an edition entity without a work entity', function(done){
  ...
  it('should reject an edition entity without a title', function(done){
    workEntityPromise
  ...
  it('should reject an edition with a label', function(done){
    workEntityPromise
    .then(workEntity => authReq('post', '/api/entities?action=create', {
  ...
  it('should accept an edition without a labels object', function(done){
    workEntityPromise
  ...
  return it('should not be able to create an edition entity with a non-work entity', function(done){
    createSerie()
