...
export async function moveInvEntityToWikidata (user: User | RemoteUser, invEntityUri: InvEntityUri) {
...
async function setReverseClaims (claims: ExpandedClaims, wdEntityUri: WdEntityUri, user: User | RemoteUser) {
