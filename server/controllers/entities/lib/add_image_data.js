...
const pickBestPic = (entity, commonsFilename, enwikiTitle, openLibraryId) => Promise.props({
...
const getPicSourceOrder = entity => {
  ...
  case 'work':
    ...
    const publicationYear = __guard__(entity.claims['wdt:P577'] != null ? entity.claims['wdt:P577'][0] : undefined, x => x.split('-')[0])
