...
import type { EntityUri, SerializedEntitiesByUris, SerializedEntity, WikimediaCommonsFilename } from '#types/entity'
import type { EntityImagePath } from '#types/image'
