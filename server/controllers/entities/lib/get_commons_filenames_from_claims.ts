...
import type { SimplifiedClaimsIncludingWdExtra, WikimediaCommonsFilename } from '#types/entity'
...
export function getCommonsFilenamesFromClaims (claims: SimplifiedClaimsIncludingWdExtra) {
