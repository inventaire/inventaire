...
describe('content', () => describe('body-parser', function() {
  ...
  it('should reject url encoded bodies', function(done){
    const params = {
      method: 'POST',
      url: `${host}/api/tests`,
      headers: {
  ...
  return it('should make an exception for /api/submit', function(done){
    const params = {
      method: 'POST',
