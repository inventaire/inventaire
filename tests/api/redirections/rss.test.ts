...
describe('rss redirections', () => {
  it('should redirect to a user feed by id', async () => {
    ...
    headers.location.should.equal(`${origin}/api/feeds?user=${_id}`)
  })
  ...
  it('should redirect to a group feed by id', async () => {
    ...
    headers.location.should.equal(`${origin}/api/feeds?group=${_id}`)
  })
  ...
  it('should redirect to a shelf feed by id', async () => {
    ...
    headers.location.should.equal(`${origin}/api/feeds?shelf=${_id}`)
  })
})
